	...
	async execute(interaction) {
		...
		if (action == 'rules') {
			...
			const RulesEmbed = new MessageEmbed()
				.setColor(color)
				.setDescription(`
Before engaging in discussion in the server, you must read and agree to the rules:
...
• Do not ping the moderators or admins if you're issue isnt extremely urgant!

• Ensure you have DMs enabled. This is how you are notified of punishment and reasoning.

• If you are banned, you can submit an appeal here: https://forms.gle/wPR1c977eXFpebVK7\n
...
• Advertising of any kind is not permitted, this includes, but is not limited to:\n > YouTube channels, Twitch streams, Twitter profiles and any other social media platform you use to establish a following.`);
			...
			try {
				rulesChannel.send({ embeds: [RulesEmbed, RulesVerifyMessage] });
